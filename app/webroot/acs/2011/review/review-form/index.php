<?
$_POST['page_title'] = 'Review Form';
$_POST['extra_css'] = array('review_form.css');
...
<p class="info">Please note that this is intended only to be used as a guide. The form where you may enter your paper reviews will be made available as soon as possible.</p>

<fieldset>
  <h1>Review Form</h1>
  <p>
    Please complete this review form offline and enter your comments
    into the appropriate fields on the Web form. Give reasons that 
    support your answers rather than simply checking boxes.
  </p>
  <ol>
    <li>
