...
human-level intelligence, complex cognition, integrated intelligent
...
intelligence and cognitive science, which aimed to explain the mind
in computational terms and to reproduce the entire range of human
cognitive abilities in computational artifacts. Because many researchers 
remain committed to this original vision, there is need for a meeting
that provides a place to present recent results and pose new challenges 
for the field.
</p>
...
Langley (<a href="mailto:Pat Langley <patrick.w.langley@gmail.com>">
patrick.w.langley@gmail.com</a>), for additional information.
</p>
    ...
    <div class="well">
      <dl class="dl-horizontal">
        ...
        <dt>Patrick Winston</dt><dd>Massachusetts Institute of 
            Technology</dd>
      </dl>
    </div>
