<?
$this->start('css');
echo $this->Html->css('review-form');
$this->end();
?>
...
<ol>
  ...
  <li>
	...
	<label for="accept2">Conditional accept</label>
      ...
      <span>
	<input type="radio" name="accept" value="accept_poster"
	       id="accept3"/>
	<label for="accept3">Accept as Poster</label>
      </span>
      <span>
	<input type="radio" name="accept" value="reject_paper"
	       id="accept4"/>
	<label for="accept4">Reject paper</label>
      </span>
    </p>
  </li>
</ol>
